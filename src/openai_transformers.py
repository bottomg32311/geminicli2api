...
def is_valid_gemini_image(mime_type: str, base64_data: str) -> bool:
    ...
    # 2. Size Check: Filters out microscopic 1x1 tracking pixels and corrupted stubs.
    # Real character images are tens of thousands of characters long. 
                        ...
                        for m in matches:
                            ...
                            if url.startswith("data:"):
                                try:
                                    ...
                                    if is_valid_gemini_image(mime_type, base64_data):
                                        parts.append({
                                            "inlineData": {
                                                "mimeType": mime_type,
                                                "data": base64_data
                                        ...
                                        # Broken/Junk image - fallback to text so it doesn't crash
